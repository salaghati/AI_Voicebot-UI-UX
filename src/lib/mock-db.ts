...
const campaigns: Campaign[] = [
  ...
  },
  {
    ...
    workflow: "WF_CSAT",
    handoverEnabled: true,
    defaultHandoverProfileId: "hp_vip_fast_lane",
    totalCalls: 0,
    successRate: 0,
    owner: "Anh Nguyen",
...
const inbounds: InboundConfig[] = [
  ...
  },
  {
    ...
    defaultHandoverProfileId: "hp_complaint_priority",
    status: "Nháp",
...
const workflows: Workflow[] = [
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        handoverMode: "override_profile",
        handoverProfileId: "hp_complaint_priority",
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "n3", type: "Handover", label: "Chuyển agent", value: "Chuyển cuộc gọi cho tổng đài viên khi khách cần hỗ trợ trực tiếp.", ttsText: "Em chuyển cuộc gọi sang tổng đài viên để hỗ trợ trực tiếp cho anh chị.", handoverMode: "use_default", handoverTarget: "queue_payment", onHandoverFail: "end_call" },
    ],
  },
  {
    id: "WF_Mau_HoanChinh",
