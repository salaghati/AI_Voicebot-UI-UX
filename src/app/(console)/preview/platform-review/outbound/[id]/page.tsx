...
import { getKnowledgeRef, getWorkflowRef, outboundCampaignsMock } from "@/features/platform-review/mock";
...
export default function OutboundCampaignDetailPreviewPage() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title={campaign.name}
        description="Campaign Detail theo pattern chatbot."
        actions={
      ...
      {tab === "workflow" ? (
        <Card className="space-y-3">
          ...
          <div className="rounded-xl border border-[var(--line)] bg-[var(--surface-2)] p-4">
            ...
            <Link href={`/preview/platform-review/workflows/${campaign.workflowId}`} className="text-lg font-semibold text-[var(--accent)] hover:underline">
      ...
      {tab === "knowledge" ? (
        <Card className="space-y-3">
          ...
          <div className="rounded-xl border border-[var(--line)] bg-[var(--surface-2)] p-4">
            ...
            <Link href={`/preview/platform-review/kb/${campaign.kbId}`} className="text-lg font-semibold text-[var(--accent)] hover:underline">
