...
const steps = ["Thông tin Route", "Queue/Extension", "Workflow", "Knowledge Base", "Review"] as const;

export default function InboundCreateReviewPage() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        ...
        description="Create flow inbound theo pattern chatbot."
        actions={
