...
import { getKnowledgeRef, getWorkflowRef, inboundRoutesMock } from "@/features/bot-engine/mock";
...
export default function InboundRouteDetailPage() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title={route.name}
        description="Chi tiết Inbound Route"
        actions={
      ...
      {tab === "workflow" ? (
        <Card className="space-y-3">
          ...
          <div className="rounded-xl border border-[var(--line)] bg-[var(--surface-2)] p-4">
            ...
            <Link href={`/workflow/${route.workflowId}`} className="text-lg font-semibold text-[var(--accent)] hover:underline">
      ...
      {tab === "knowledge" ? (
        <Card className="space-y-3">
          ...
          <div className="rounded-xl border border-[var(--line)] bg-[var(--surface-2)] p-4">
            ...
            <Link href={`/kb/list/${route.kbId}`} className="text-lg font-semibold text-[var(--accent)] hover:underline">
